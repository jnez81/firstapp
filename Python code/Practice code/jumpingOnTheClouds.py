...
Determine the minimum number of jumps it will take to jump from the starting postion to the 
...
avoid the clouds at indices 1 and 5. They could follow these two paths: 0->2->4->6 or 0->2->3->4->6 . 
